define(["rtts-assert", './util', './history', './router', './pipelineProvider', './navigationCommand'], function($__0,$__1,$__2,$__3,$__4,$__5) {
  "use strict";
  ...
  var extend = $traceurRuntime.assertObject($__1).extend;
  var History = $traceurRuntime.assertObject($__2).History;
  var Router = $traceurRuntime.assertObject($__3).Router;
  ...
  var AppRouter = function AppRouter(history, pipelineProvider) {
    assert.argumentTypes(history, History, pipelineProvider, PipelineProvider);
  ...
  AppRouter.parameters = [[History], [PipelineProvider]];
