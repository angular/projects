define(["rtts-assert", 'rtts-assert', 'di'], function($__0,$__1,$__2) {
  ...
  var DomMovedAware = function DomMovedAware() {
    $traceurRuntime.superCall(this, $DomMovedAware.prototype, "constructor", ['domMovedAware']);
  };
  var $DomMovedAware = DomMovedAware;
  ($traceurRuntime.createClass)(DomMovedAware, {}, {}, Queryable);
  return {
    get Directive() {
      return Directive;
    },
