define(['./types', 'di', 'di', './view', './util/annotation_provider', './annotations', './component_loader', 'expressionist', './watch_group', './di/node_injector', './util/tree_array'], function($__0,$__1,$__2,$__3,$__4,$__5,$__6,$__7,$__8,$__9,$__10) {
  "use strict";
  ...
  var $__13 = $traceurRuntime.assertObject($__5),
  ...
  var $__13 = $traceurRuntime.assertObject($__9),
  ...
  var ViewFactory = function ViewFactory(annotationProvider, componentLoader, rootInjector) {
  ...
  ($traceurRuntime.createClass)(ViewFactory, {
    createComponentView: function($__13) {
      var element = "element" in $__13 ? $__13.element : null,
          ...
          viewPort = $__13.viewPort;
      var annotation = this.annotationProvider(component, Directive);
      if (!element) {
    ...
    _initTemplate: function($__17) {
      ...
      if (executionContext) {
        localProviders.push(createValueProvider(EXECUTION_CONTEXT_TOKEN, executionContext));
      }
      var self = this;
      var container;
  ...
  ViewFactory.annotations = [new Inject(AnnotationProvider, ComponentLoader, RootInjector)];
  ...
  function createValueProvider(token, value) {
    ...
    valueProvider.annotations = [new Provide(token)];
