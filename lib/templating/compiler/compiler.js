define(["rtts-assert", '../types', './directive_class', './selector', '../annotations', 'di', '../util/annotation_provider', '../util/tree_array'], function($__0,$__1,$__2,$__3,$__4,$__5,$__6,$__7) {
  "use strict";
  ...
  var AnnotationProvider = $traceurRuntime.assertObject($__6).AnnotationProvider;
  var reduceTree = $traceurRuntime.assertObject($__7).reduceTree;
  var Compiler = function Compiler(selectorFactory, annotationProvider) {
  ...
  Compiler.parameters = [[new InjectLazy(Selector)], [new Inject(AnnotationProvider)]];
