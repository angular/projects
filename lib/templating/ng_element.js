define(['./di/ce_di', './annotations', './view_factory', './component_loader', './util/misc', 'di', './di/node_injector'], function($__0,$__1,$__2,$__3,$__4,$__5,$__6) {
  "use strict";
  ...
  var getAnnotation = $traceurRuntime.assertObject($__4).getAnnotation;
  ...
  function registerNgElement(componentLoader, registerCustomElement) {
  ...
  registerNgElement.annotations = [new Inject(ComponentLoader, RegisterCustomElement), new TransientScope];
  ...
  RegisterCustomElement.annotations = [new Inject(ViewFactory, RootInjector)];
  return {
