define(['./util/misc', './annotations', 'di', './compiler/compiler', './load_barrier'], function($__0,$__1,$__2,$__3,$__4) {
  "use strict";
  ...
  if (!$__4 || !$__4.__esModule)
    $__4 = {'default': $__4};
  var getAnnotation = $traceurRuntime.assertObject($__0).getAnnotation;
  ...
  var ComponentLoader = function ComponentLoader(injector) {
  ...
  ($traceurRuntime.createClass)(ComponentLoader, {
    ...
    loadFromElement: function(element, done) {
      ...
      require(configModuleIds, (function() {
        ...
        var compileInjector = $__5._injector.createChild(providers);
  ...
  ComponentLoader.annotations = [new Inject(Injector)];
  return {
    get ComponentLoader() {
