define(['expressionist', 'expressionist', 'watchtower', 'watchtower', 'di', './di/node_injector', './annotations'], function($__0,$__1,$__2,$__3,$__4,$__5,$__6) {
  ...
  var AttachAware = $traceurRuntime.assertObject($__6).AttachAware;
  ...
  RootWatchGroup.annotations = [new AttachAware, new Inject(WatchParser, ObserverSelector)];
  ...
  ChildWatchGroup.annotations = [new Inject(WatchParser, RootWatchGroup), new AttachAware()];
